...
preamble_sym = (1 + 1i)*cos(pi*(1:preamble_length/samp_per_sym));
...
x = real(x);       % only use the real part for cancellation
...
y = a(2, tx_beg:tx_end) ;%+ 1i*a(2,tx_beg:tx_end);
fclose(fid);
